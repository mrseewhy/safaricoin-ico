...
trait UserAttribute
{
    ...
    {
        return '<a href="'.route('admin.auth.user.show', $this).'"  title="'.__('buttons.general.crud.view').'" class="btn btn-outline-secondary"><i class="fa fa-eye" data-toggle="tooltip" data-placement="top"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.auth.user.edit', $this).'" class="btn btn-outline-primary" title="'.__('buttons.general.crud.edit').'"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top"></i></a>';
    }
            ...
            switch ($this->active) {
                ...
                case 1:
                    return '<a href="'.route('admin.auth.user.mark', [
                            $this,
                            0,
                        ]).'" class="dropdown-item">'.__('Suspend').'</a> ';
                // No break
    ...
    public function getActionButtonsAttribute()
    {
    	...
    	<div class="btn-group" role="group" aria-label="User Actions">
		  ...
		  <div class="btn-group" role="group">
			<button id="userActions" type="button" class="btn btn-outline-danger dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
			  More
			</button>
